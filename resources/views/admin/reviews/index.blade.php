   ...
   <div class="bg-white rounded-lg shadow-sm border border-gray-100 mb-8">
        <div class="flex flex-col-reverse md:flex-row">
            ...
            <div class="flex-grow p-4 sm:p-6 space-y-4">
                {{-- Ensure $reviews is available and $totalReviews is the correct total count --}}
            ...
            <div class="bg-yellow-50 p-8 md:w-64 flex flex-col items-center justify-center">
                ...
                @php
                    $roundedRating = round($averageRating * 2) / 2; // Round to nearest 0.5
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between mb-8">
                <h3 class="text-xl font-black text-gray-900">Review Timeline</h3>
                <div class="flex gap-2">
                    <span class="px-3 py-1 bg-gray-50 text-gray-500 text-[10px] font-bold rounded-full uppercase tracking-tighter">Last 30 Days</span>
                </div>
            </div>
